...
public class TestToolbar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_livingroom_toolbar);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.tool_bar_livingroom, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_about:
                Context context = getApplicationContext();
                CharSequence text = "This application will allow you to control the different room devices such as t, lights and blinds";
                int duration = Toast.LENGTH_SHORT;
